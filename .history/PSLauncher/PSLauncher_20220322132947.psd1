...
@{
    ...
    Description       = 'A GUI to launch any PowerShell script, function, file or any other executables. You can also create a systray tool for quick access. One systray tool will use
the same json config file as the full gui.
