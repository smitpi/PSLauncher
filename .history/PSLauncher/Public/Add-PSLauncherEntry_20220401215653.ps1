...
Function Add-PSLauncherEntry {
	...
	Param (
		...
		[System.IO.FileInfo]$PSLauncherConfigFile = (Add-Type -AssemblyName System.Windows.Forms.OpenFileDialog; $FileBrowser = New-Object System.Windows.Forms.OpenFileDialog -Property @{ Filter = 'JSON | *.json' }
			$null = $FileBrowser.ShowDialog()
			Get-Item $FileBrowser.FileName),
