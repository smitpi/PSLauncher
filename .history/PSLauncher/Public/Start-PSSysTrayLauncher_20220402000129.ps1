...
Function Start-PSSysTrayLauncher {
    ...
    $Runspace.SessionStateProxy.SetVariable('jsondata', $jsondata)
    $Runspace.SessionStateProxy.SetVariable('PSLauncherConfigFile', $PSLauncherConfigFile)
